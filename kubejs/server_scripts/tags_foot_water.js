...
ServerEvents.tags('fluid', event => {
    ...
    event.add('kubejs:grass_ash_water', 'kubejs:grass_ash_water')
    event.add('kubejs:fuma_foot_water', 'kubejs:fuma_foot_water')
    event.add('kubejs:fuma_low_PH_foot_water', 'kubejs:fuma_low_PH_foot_water')
    event.add('kubejs:salted_plantoil', 'kubejs:salted_plantoil')
